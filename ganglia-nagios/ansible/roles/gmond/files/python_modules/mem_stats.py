...
def metrics_handler(name):
    ...
    if name == 'mem_total_used':
        return metrics_handler('mem_phy_total') - metrics_handler('mem_free') - metrics_handler('mem_buffers') - metrics_handler('mem_cached')
    if name == 'mem_used_percent':
        return metrics_handler('mem_total_used') / metrics_handler('mem_phy_total') * 100
    for line in file:
...
def metric_init(params):
    ...
    descriptors.append(create_desc(Desc_Skel, {
                ...
                "orig_name"  : "NA",
                "units"      : "Bytes",
                "description": "Calculated metric.  MemTotal - MemFree - Buffers - Cached",
                }))
    ...
    descriptors.append(create_desc(Desc_Skel, {
                ...
                "orig_name"  : "NA",
                "units"      : "%",
                "description": "Calculated metric. Percent of mem usage",
                }))
